      ...
      setGuaguaka (guaguakaInfo) {
        ...
        if (guaguakaInfo) {
          if (!guaguakaInfo.id && this.id === null) {
            ...
            const windowWidth = document.documentElement.style.fontSize.split('px')[0]
            ...
            this.curtainHide = !guaguakaInfo.curtainHide ? !true : true
            ...
            if (guaguakaInfo.width && guaguakaInfo.width.indexOf('rem') > -1) {
              this.guaguaka_width = guaguakaInfo.width.split('rem')[0] * windowWidth + 'px'
            }
            this.guaguaka_height = guaguakaInfo.height ? guaguakaInfo.height : this.guaguaka_height
            if (guaguakaInfo.height && guaguakaInfo.height.indexOf('rem') > -1) {
              this.guaguaka_height = guaguakaInfo.height.split('rem')[0] * windowWidth + 'px'
            }
